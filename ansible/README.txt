...
docker container run --volume C:/miel/workspace/infra/Ansible:/tmp/ansible --interactive --tty ansible-2.9 bash
docker container run --volume C:/miel/workspace/infra/Ansible:/tmp/ansible --interactive --tty ansible-2.10 bash
docker container run --volume C:/miel/workspace/infra/Ansible:/tmp/ansible --interactive --tty ansible-2.10-apt bash
